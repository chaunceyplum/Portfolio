      ...
      <Container className='bg spacer'>
        <Row className='bg space-evenly'>
          <Col className='bg1 ' xs={12} lg={3}>
            <h3 className=' spacer'>Chauncey Plummer</h3>
            <h6 className='spacer'>Front End Web Developer</h6>
            <img />

            <h6 className='spacer'>About Me</h6>
            <p>
              An infectiously enthusiastic Front End Web Developent Bootcamp
              graduate with fundamental knowledge of web development. Seeking to
              utilize advanced expertise in javaScript
            </p>
